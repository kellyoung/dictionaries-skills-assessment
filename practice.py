...
def get_sum_zero_pairs(numbers):
    ...
    for index, number in enumerate(numbers):
        if number == 0:
            ...
            zero_pair.append(numbers.pop(pair_index))
...
def top_chars(phrase):
    ...
    for character in phrase:
        if not character.isspace():
            character_counts[character] = (character_counts.get(character,
                                                                0) + 1)
    ...
    #find characters that have maximum count and append to return list
    for character_count in character_counts:
        if character_counts[character_count] == max_count:
            most_frequent_chars.append(character_count)
